...
const promises: TrackingPromise[] = [
  ...
  },
  {
    ...
    isNCPO: false,
    imageUrl: 'รวมพลังประชาชาติไทย_8',
    links: [],
    timelines: [],
  },
  {
  ...
  },
  {
    ...
    isNCPO: false,
    imageUrl: 'รวมพลังประชาชาติไทย_2',
    links: [],
    timelines: [],
  },
];
...
test('should return group title', () => {
  ...
  expect(getGroupTitle('status', 'nodata')).toBe('สถานะ: ไม่พบข้อมูล');
