<template>
  ...
  >
    <h1 class="wv-h5 wv-font-kondolar wv-font-bold text-white pb-4">
      เส้นทางของคำสัญญา
    </h1>
    <div
      class="flex flex-col items-center sm:flex-row sm:items-start pt-4 sm:p-4"
    >
      ...
      <div>
        <div
          ...
          :key="data.id"
          class="flex flex-col md:flex-row text-white m-4"
        >
          <div class="flex wv-u4 wv-font-anuphan wv-font-bold">
            <span class="pr-2" v-html="data.icon"></span>
            <span class="w-24 mr-2 mb-2">{{ data.name }}</span>
          </div>
          <p class="wv-b6 wv-font-baijamjuri">
            {{ data.description }}
          </p>
        </div>
      </div>
...
export default Vue.extend({
  name: 'StatusExplaination',
  components: { ProcessFlowchart },
  data() {
    return {
      dataArray: [
        {
          ...
          name: 'ไม่พบข้อมูล',
          description: 'ไม่พบข้อมูล แผนงาน ในการดำเนินการคำสัญญา',
        },
        {
          id: 1,
