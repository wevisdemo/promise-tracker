<template>
  <div
    class="flex flex-col bg-ultramarine md:w-80 self-start fixed md:sticky bottom-0 left-0 right-0 md:h-auto md:top-10 md:mr-12 z-50 border-white border"
    :class="{ 'h-screen': isDialogOpenInMobile }"
  >
    <div class="flex md:hidden flex-row text-white p-3 space-x-2 items-center">
    ...
    <div
      :class="`flex flex-col overflow-y-auto ${
        isDialogOpenInMobile ? 'flex-1' : 'h-0 md:flex-1'
      }`"
    >
      <div
